...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "War in Hex"

        #Project url
        self.project_url = "https://github.com/wolfmankurd/war_in_hex"

        #Version of program
        self.project_version = "0.3.5"

        #License of the program
        self.license = "MyApps License"

        #Auhor of program
        self.author_name = "Ali Raheem"
        self.author_email = "example@example.com"
        self.copyright = "Copyright (c) 2016 Me."

        #Description
        self.project_description = "War in Hex is a Hive(r) style abstract strategy game."
